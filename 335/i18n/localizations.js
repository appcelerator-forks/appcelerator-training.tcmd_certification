...
String.toLocaleString({
	"en-US": {
		...
		"%l_lab": "Lab",
		"%l_slidenote_lab": "In TiBountyHunter, point out the use of the scroll view in DetailWindow.js – it is used to segment detail information about the fugitive, like the fugitive description and their location on a map (unimplemented, but easily could be)."
