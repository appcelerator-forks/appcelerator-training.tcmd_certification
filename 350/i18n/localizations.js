...
String.toLocaleString({
	...
	"ES": {
		...
		"%l_low_cost": "Teléfonos de bajo coste que en una variedad de hardware",
		"%l_java": "Basada en un medio ambiente Java (conjunto de habilidades comunes)",
		"%l_great": "Gran número de aplicaciones de Google",
		"%l_slidenote_android_strengths": "Some carriers restrict installation of non-market apps",
		
		"%l_ti_android_strengths": "Fortalezas de la plataforma Ti Android",
		"%l_ios_support": "Mucha soporte a la funcionalidad específica de sistema operativo, se centran en 'best of breed' (lo mejor del mercado) experiencia",
		...
		"%l_less_active": "Menos de aplicación activa la economía (reducción de las compras)",
		...
		"%l_activity_def": "'Una actividad es una sola cosa, centrada en que el usuario pueda hacer. Casi todas las actividades de interactuar con el usuario, por lo que el tipo de actividad se ocupa de la creación de una ventana para que usted puede colocar su interfaz de usuario'",
		"%l_activity_url": "<a href='http://developer.android.com/reference/android/app/Activity.html'>http://developer.android.com/reference/android/app/Activity.html</a>",		
		"%l_slidenote_android_vocab": "An app is made up from one or more activities: one to list email messages, one to compose a message, one to read a message, etc.",
		...
		"%l_broadcast": "Receptor de radiodifusión",
		"%l_broadcast_def": "'Un receptor de radiodifusión es un componente que responde a mensajes de difusión en todo el sistema'",
		"%l_broadcast_url": "<a href='http://developer.android.com/reference/android/content/BroadcastReceiver.html'>http://developer.android.com/reference/android/content/BroadcastReceiver.html</a>",
		"%l_slidenote_android_vocab_3": "<ul><li>System broadcasts: screen is on/off, battery is low, picture was captured</li><li>Your app could initiate a broadcast (when data is available to be used by other apps) or react to broadcasts</li><li>Broadcasts don't interact with the user (no UI) except via a notification in the Notification Bar</li></ul>",
		
		"%l_intent": "Intenciones",
		"%l_intent_def": "'Tres de los componentes básicos de una aplicación - las actividades, servicios y receptores de radio - se activan a través de mensajes, llamada intenciones.'",
		"%l_intent_url": "<a href='http://developer.android.com/guide/topics/intents/intents-filters.html'>http://developer.android.com/guide/topics/intents/intents-filters.html</a>",
		"%l_slidenote_android_vocab_4": "<ul><li>Intents are basically message objects that hold data which pass from one activity to a service, or one activity to another activity, etc.</li><li>Broadcasts are communicated in the form of events</li><li>For security reasons, your app can't directly start an activity in another app. Instead, you send an intent requesting that activity and the OS starts the activity on your app's behalf</li><li>You can request service from another activity directly (call on it) or you can publish an intent and a 'filter' describing the type of service you need and let the OS find appropriate activities for you (think of how the Share button works &mdash; your app is publishing some text and the OS is returning all the activities that could share that text: email, twitter, etc.</li></ul>",
		
		"%l_all_these": "Todos ellos trabajan en Ti",
		"%l_slidenote_all_these": "Much of this goes on behind the scenes without you having to worry a lot over it. But you can manage the process and take specific actions to capitalize on this application architecture",
		...
		"%l_slidenote_android_config": "ul><li>Actividades, servicios y proveedores de contenido que no se definen en el manifiesto no son visibles para el sistema operativo y por lo tanto no se puede iniciar</li><li>Titanium añade estos elementos, pero también se puede definir o configurar su propia cuenta</li><li>Utilice también el manifiesto para definir las necesidades de hardware (orientación, tamaño de la pantalla y la densidad, la versión de la plataforma)</li></ul><b>Demo</b><ul><li>Muestre kitchen sink tiapp.xml &mdash; configuraciones de actividades y servicios</li><li>Via finder, abra KS/build/android/AndroidManifest.xml</li><li><intent-filter> describe las capacidades de sus actividades para el sistema operativo sepa qué tipo de intenciones que podrían responder a</li><li>explicar cómo se puede crear un manifiesto personalizado (cubierta en el módulo de orientación)</li></ul>",
		...
		"%l_styling_props": "Propiedades de estilo de plataforma cruzada misma creación",
		...
		"%l_demo_label": "Demo: Gimnástica de la etiqueta",
		"%l_slidenote_android_labels": "Demo - KitchenSink: label_linkify.js<br>iOS soportes similares de auto-vinculación de las áreas de texto",
		"%l_toast": "Notificaciones de Toast",
		"%l_toast_image": "<img src='images/toast.png' style='margin-top:5px;height:380px;float:right;'/>",
		...
		"%l_launch_other": "Puede iniciar otras aplicaciones (actividades) de JS",
		"%l_intent_pass": "Necesidad de contar con un objeto intentar hacerlos pasar por",
		"%l_many_built": "Muchos intentos de construcción para utilizar",
		"%l_forging_ti": "Forging Titanium #9 - Recetario de intenciones de Android",
		"%l_launch_act_url": "<a href='http://bit.ly/ryOSW4'>http://bit.ly/ryOSW4 </a>",
		"%l_slidenote_launch_act": "Una aplicación se compone de una o más actividades: una a la lista de mensajes de correo electrónico, uno para redactar un mensaje, uno para leer un mensaje, etc Otras aplicaciones <br> puede iniciar una actividad dentro de su aplicación y su aplicación puede iniciar actividades en el <br> otras aplicaciones Esto le da una forma de compartir la funcionalidad y hacer que parezca ser parte de su aplicación",
		"%l_service_supp": "Soporte de servicios",
		"%l_js_service": "Usted puede servicios basados en js que se ejecutan en segundo plano",
		"%l_can_comm": "Puede comunicarse con ella desde la aplicación principal",
		"%l_demo_bg": "Demo: fondo de servicio",
