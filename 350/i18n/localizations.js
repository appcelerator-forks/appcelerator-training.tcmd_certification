...
String.toLocaleString({
	"en-US": {
		...
		"%l_slidenote_titleslide": "<b>Module time: 90 mins</b>(60 mins teaching, 30 mins lab)",
		...
		"%l_slidenote_android_key": "<ul><li>Aevery app has the three components above, and we will explore each.  They form the fundamental building blocks of an android app</li><li><b>READ THE ANDROID APP FUNDAMENTALS!!!!!!!!!!  DON’T CHEAT AND HOPE TITANIUM WILL UNDERSTAND ALL OF ANDROID FOR YOU!</b></li></ul>",
		
		"%l_android_vocab": "Android Vocabulary",
		"%l_activity": "Activity",
		"%l_activity_def": "'An activity is a single, focused thing that the user can do. Almost all activities interact with the user, so the Activity class takes care of creating a window for you in which you can place your UI'' style='margin-top:5px;height:380px;float:right;'/>",
		...
		"%l_slidenote_hardware": "Demo: KitchenSink – android_menu1, 2, and 3",
